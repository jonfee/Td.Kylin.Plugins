...
namespace Td.Kylin.Message.SysMessage
{
    ...
    /// 商家确认商品订单后消息发送器
    /// </summary>
    public class MerchantConfirmGoodsOrderMessageSender : SysMessageSender
    {
        #region 属性
        ...
        public MerchantConfirmGoodsOrderMessageSender(int orderId) : base(MessageTemplateOption.MerchantSureGoodsOrder)
        {
            _orderID = orderId;
